...
using PhanThiHoaiAnh_223DATN_DVTC.Areas.VNPayAPI.Util;
using System.Web;

namespace PhanThiHoaiAnh_223DATN_DVTC.Areas.VNPayAPI.Controllers
{
    [Area("VNPayAPI")]
    public class HomeController : Controller
    {
        public string url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        public string returnUrl = $"https://localhost:37963/vnpayAPI/PaymentConfirm";
        public string tmnCode = "OVGGCO84";
        public string hashSecret = "3HZWT4PP8FZQQ39GIYZDDQS7H8WB0SCS";
            ...
            if (Request.QueryString.HasValue)
            {
                ...
                if (checkSignature && tmnCode == json["vnp_TmnCode"].ToString())
                {
                    if (vnp_ResponseCode == "00")
                    {
                        ...
                        return Redirect($"DatTiec/Confirm/{orderId}&{vnpayTranId}&{orderInfor}");
                    }
                    else
                    {
