    ...
    public class SeedData
    {
        public static void SeedingData(DataContext _context)
        {
            ...
            if (!_context.FoodModel.Any())
            {
                ...
                FoodCategoryModel foodc1 = new FoodCategoryModel { Id = "MMan", CategoryName = "Món mặn"};
                FoodCategoryModel foodc2 = new FoodCategoryModel { Id = "MChien", CategoryName = "Món chiên" };
